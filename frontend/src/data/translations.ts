...
const TRANSLATIONS: Record<string, Partial<Record<LanguageCode, string>>> = {
  ...
  settings_admin_subtitle: {
    en: 'Server runtime configuration (admin token required).',
    he: 'תצורת שרת בזמן ריצה (נדרש אסימון מנהל).',
    ru: 'Серверная конфигурация (нужен admin-токен).',
  },
  ...
  admin_login_subtitle: {
    en: 'Enter the server admin token to manage runtime settings.',
    he: 'הזינו את אסימון המנהל של השרת כדי לנהל הגדרות.',
    ru: 'Введите admin-токен сервера для управления настройками.',
  },
