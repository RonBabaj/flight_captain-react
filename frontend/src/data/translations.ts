...
const TRANSLATIONS: Record<string, Partial<Record<LanguageCode, string>>> = {
  ...
  settings_admin_subtitle: {
    en: 'Sign in with your admin account to manage server runtime settings.',
    he: 'התחברו עם חשבון מנהל כדי לנהל הגדרות שרת.',
    ru: 'Войдите как администратор для управления серверными настройками.',
  },
