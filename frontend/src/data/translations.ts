...
const TRANSLATIONS: Record<string, Partial<Record<LanguageCode, string>>> = {
  ...
  nav_hotel_deals: { en: 'Hotel Deals', he: 'דילי מלונות', ru: 'Отели' },
  hotel_deals_title: {
    en: 'Hotel Deals',
    he: 'דילי מלונות',
    ru: 'Выгодные отели',
  },
  hotel_deals_subtitle: {
    en: 'Search RateHawk hotel inventory through Fly-Fix. Prices from search are estimates until you open a live hotel rate.',
    he: 'חפשו מלונות דרך Fly-Fix. מחירים מחיפוש הם הערכות עד לפתיחת תעריף חי.',
    ru: 'Ищите отели через Fly-Fix. Цены из поиска — оценки, пока вы не откроете живой тариф.',
  },
  hotel_destination: { en: 'Destination', he: 'יעד', ru: 'Направление' },
  hotel_destination_placeholder: {
    en: 'City or hotel name',
    he: 'עיר או שם מלון',
    ru: 'Город или название отеля',
  },
  hotel_checkin: { en: 'Check-in', he: 'צ׳ק־אין', ru: 'Заезд' },
  hotel_checkout: { en: 'Check-out', he: 'צ׳ק־אאוט', ru: 'Выезд' },
  hotel_guests: { en: 'Guests', he: 'אורחים', ru: 'Гости' },
  hotel_rooms: { en: 'Rooms', he: 'חדרים', ru: 'Номера' },
  hotel_free_cancellation: { en: 'Free cancellation', he: 'ביטול חינם', ru: 'Бесплатная отмена' },
  hotel_breakfast: { en: 'Breakfast included', he: 'ארוחת בוקר כלולה', ru: 'Завтрак включён' },
  hotel_min_stars: { en: 'Minimum stars', he: 'דירוג כוכבים מינימלי', ru: 'Минимум звёзд' },
  hotel_any: { en: 'Any', he: 'הכל', ru: 'Любой' },
  hotel_search_cta: { en: 'Search hotels', he: 'חפש מלונות', ru: 'Искать отели' },
  hotel_edit_search: { en: 'Edit search', he: 'ערוך חיפוש', ru: 'Изменить поиск' },
  hotel_no_results: { en: 'No hotels found', he: 'לא נמצאו מלונות', ru: 'Отели не найдены' },
  hotel_no_results_tip: {
    en: 'Try different dates or a nearby city.',
    he: 'נסו תאריכים אחרים או עיר קרובה.',
    ru: 'Попробуйте другие даты или соседний город.',
  },
  hotel_view_deal: { en: 'View Deal', he: 'צפה בדיל', ru: 'Смотреть предложение' },
  hotel_price_estimated: { en: 'Estimated price', he: 'מחיר משוער', ru: 'Оценочная цена' },
  hotel_price_live: { en: 'Live price', he: 'מחיר חי', ru: 'Актуальная цена' },
  hotel_prices_estimated: {
    en: 'Search prices are estimates until verified with a live hotel rate.',
    he: 'מחירי החיפוש הם הערכות עד לאימות בתעריף חי.',
    ru: 'Цены поиска — оценки, пока не проверены живым тарифом.',
  },
  hotel_nights: { en: 'nights', he: 'לילות', ru: 'ночей' },
  hotel_night: { en: 'night', he: 'לילה', ru: 'ночь' },
  hotel_guest_rating: { en: 'Guest rating', he: 'דירוג אורחים', ru: 'Оценка гостей' },
  hotel_sort_cheapest: { en: 'Cheapest', he: 'הזול ביותר', ru: 'Дешевле' },
  hotel_sort_cheapest_hint: {
    en: 'Sorted by lowest total stay price.',
    he: 'ממוין לפי המחיר הכולל הנמוך ביותר.',
    ru: 'Сортировка по наименьшей полной цене проживания.',
  },
  hotel_sort_best_value: { en: 'Best value', he: 'הכי משתלם', ru: 'Выгода' },
  hotel_sort_best_value_hint: {
    en: 'Best value = total price ÷ guest rating ÷ star rating (lower is better).',
    he: 'משתלם = מחיר כולל ÷ דירוג אורחים ÷ כוכבים (נמוך יותר = טוב יותר).',
    ru: 'Выгода = цена ÷ оценка гостей ÷ звёзды (меньше — лучше).',
  },
  hotel_sort_highest_rated: { en: 'Highest rated', he: 'דירוג גבוה', ru: 'Выше рейтинг' },
  hotel_sort_highest_rated_hint: {
    en: 'Sorted by guest rating, then stars.',
    he: 'ממוין לפי דירוג אורחים ואז כוכבים.',
    ru: 'Сортировка по оценке гостей, затем по звёздам.',
  },
  hotel_sort_most_popular: { en: 'Most popular', he: 'הכי פופולרי', ru: 'Популярные' },
  hotel_sort_most_popular_hint: {
    en: 'Sorted by review count, then guest rating.',
    he: 'ממוין לפי מספר ביקורות ואז דירוג אורחים.',
    ru: 'Сортировка по числу отзывов, затем по оценке.',
  },
  hotel_err_destination: { en: 'Enter a destination', he: 'הזינו יעד', ru: 'Укажите направление' },
  hotel_err_dates: { en: 'Check-out must be after check-in', he: 'צ׳ק־אאוט חייב להיות אחרי צ׳ק־אין', ru: 'Выезд должен быть позже заезда' },
  hotel_err_search: { en: 'Hotel search unavailable right now', he: 'חיפוש מלונות אינו זמין כרגע', ru: 'Поиск отелей временно недоступен' },
  hotel_find_hotels: { en: 'Find hotels', he: 'מצא מלונות', ru: 'Найти отели' },
  hotel_estimate_label: { en: 'Estimated hotel', he: 'מלון משוער', ru: 'Оценка отеля' },
  hotel_estimate_unavailable: { en: 'Hotel prices unavailable', he: 'מחירי מלונות אינם זמינים', ru: 'Цены на отели недоступны' },
  trip_total_estimated: { en: 'Estimated trip total', he: 'סה״כ טיול משוער', ru: 'Оценка поездки' },
  trip_total_live: { en: 'Trip total', he: 'סה״כ טיול', ru: 'Итого поездка' },
  flight_label: { en: 'Flight', he: 'טיסה', ru: 'Рейс' },
  landing_hero_title: {
